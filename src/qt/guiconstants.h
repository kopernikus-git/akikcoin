...
/* Akikcoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Akikcoin"
#define QAPP_ORG_DOMAIN "akikcoin.org"
#define QAPP_APP_NAME_DEFAULT "Akikcoin-Qt"
#define QAPP_APP_NAME_TESTNET "Akikcoin-Qt-testnet"
