...
from fake_stake.base_test import Akikcoin_FakeStakeTest

class zAKCValidCoinSpendTest(Akikcoin_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zAKCs..." % DENOM_TO_USE)
