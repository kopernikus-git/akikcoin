Contributing to Akikcoin Core
============================

The Akikcoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/akikcoin-project/akikcoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Akikcoin Core project, and is not to be
confused with overall Akikcoin Network Protocol consensus changes.

Whether a pull request is merged into Akikcoin Core rests with the project merge
...
Patches that change Akikcoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the Akikcoin consensus, it must have been
...
The project leader is the release manager for each Akikcoin Core release.
