...
/** Utility functions used by the Akikcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Akikcoin addresses in monospace font
...
// Parse "akikcoin:" URI into recipient object, return true on successful parsing
