...
#ifndef Akikcoin_ZAKCWALLET_H
#define Akikcoin_ZAKCWALLET_H
...
public:
    CzAKCWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZAKC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZAKC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
