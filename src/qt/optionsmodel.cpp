...
// Wallet
    ...
    if (settings.contains("nAnonymizeAkikcoinAmount"))
        SoftSetArg("-anonymizeakikcoinamount", settings.value("nAnonymizeAkikcoinAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in akikcoin.cpp during shotdown to also remove the window positions
