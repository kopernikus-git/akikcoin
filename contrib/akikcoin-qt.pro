...
RESOURCES += src/qt/akikcoin.qrc src/qt/akikcoin_locale.qrc

TRANSLATIONS += src/qt/locale/akikcoin_bg.ts \
                src/qt/locale/akikcoin_de.ts \
                src/qt/locale/akikcoin_en.ts \
                src/qt/locale/akikcoin_es.ts \
                src/qt/locale/akikcoin_fi.ts \
                src/qt/locale/akikcoin_fr.ts \
                src/qt/locale/akikcoin_it.ts \
                src/qt/locale/akikcoin_ja.ts \
                src/qt/locale/akikcoin_pl.ts \
                src/qt/locale/akikcoin_pt.ts \
                src/qt/locale/akikcoin_ru.ts \
                src/qt/locale/akikcoin_sk.ts \
                src/qt/locale/akikcoin_sv.ts \
                src/qt/locale/akikcoin_vi.ts \
                src/qt/locale/akikcoin_zh_CN.ts \
                src/qt/locale/akikcoin_zh_TW.ts
