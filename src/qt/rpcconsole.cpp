                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzAKCPathCustom = GetArg("-zakcbackuppath", "");
    ...
    if(!strzAKCPathCustom.empty()) {
        ui->wallet_customzakcbackuppath->setText(QString::fromStdString(strzAKCPathCustom));
        ui->wallet_customzakcbackuppath_label->setVisible(true);
        ui->wallet_customzakcbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzAKCPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Akikcoin RPC console.") + "<br>" +
