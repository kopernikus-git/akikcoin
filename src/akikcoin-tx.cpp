...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Akikcoin Core akikcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  akikcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded akikcoin transaction") + "\n" +
                               "  akikcoin-tx [options] -create [commands]   " + _("Create hex-encoded akikcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded akikcoin transaction
