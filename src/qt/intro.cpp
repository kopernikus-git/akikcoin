...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Akikcoin Core"),
     ...
     * override -datadir in the akikcoin.conf file in the default data directory
     * (to be consistent with akikcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
