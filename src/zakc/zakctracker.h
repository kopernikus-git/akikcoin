...
#ifndef Akikcoin_ZAKCTRACKER_H
#define Akikcoin_ZAKCTRACKER_H
...
public:
    CzAKCTracker(std::string strWalletFile);
    ~CzAKCTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzAKCWallet* zAKCWallet = NULL);
