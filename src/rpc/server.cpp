...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Akikcoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Akikcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Akikcoin features */
        {"akikcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"akikcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"akikcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"akikcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"akikcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"akikcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"akikcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"akikcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"akikcoin", "startmasternode", &startmasternode, true, true, false},
        {"akikcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"akikcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"akikcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"akikcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"akikcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"akikcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"akikcoin", "preparebudget", &preparebudget, true, true, false},
        {"akikcoin", "submitbudget", &submitbudget, true, true, false},
        {"akikcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"akikcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"akikcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"akikcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"akikcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"akikcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"akikcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"akikcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"akikcoin", "mnsync", &mnsync, true, true, false},
        {"akikcoin", "spork", &spork, true, true, false},
        {"akikcoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzakcseed", &getzakcseed, false, false, true},
        {"zerocoin", "setzakcseed", &setzakcseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzakc", &searchdzakc, false, false, true},
        {"zerocoin", "dzakcstate", &dzakcstate, false, false, true},
...
{
    return "> akikcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:19531/\n";
}
